...
def cs_sidebar():
    ...
    st.sidebar.markdown('''<small>Developed by <b>Swetha Saravanan<b></small>''', unsafe_allow_html=True)
    st.sidebar.markdown('''
...
pip install streamlit-nightly --upgrade
    ...
    st.sidebar.markdown('''<small>May 2024 | [<b>Swetha Saravanan<b>](https://github.com/sswethasaravanan)</small>''', unsafe_allow_html=True)
    return None
